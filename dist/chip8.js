...
function __wbg_adapter_38(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hea6ff069e2250200(arg0, arg1);
}
...
* @returns {Uint8Array}
*/
export function fetch_byte_array_from_js() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.fetch_byte_array_from_js(retptr);
...
* @returns {any}
*/
export function send_new_config_to_js() {
    const ret = wasm.send_new_config_to_js();
    return takeObject(ret);
}

/**
*/
export function reset_core() {
    wasm.reset_core();
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getbytearray_7ba42374593411a9 = function() {
